...
int main()
{
    ...
    for (int i = 0; i < 4; ++i)
    {
        cout << pqueue_test_descriptions[i] << endl
             << get_status_str(pqueue_test_results[i]) << endl;
    }
    cout << endl;
    ...
    bst_test_results[0] = bst_test.test1(); // problem could lie here
    ...
    for (int i = 0; i < 0; ++i)
    {
        cout << bst_test_descriptions[i] << endl
             << get_status_str(bst_test_results[i]) << endl;
    }
    cout << endl;
}
